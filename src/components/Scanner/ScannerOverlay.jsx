                ...
                <div className="relative">
                  ...
                  <div className="absolute inset-0 pointer-events-none">
                    <div className="absolute top-0 left-0 w-10 h-10">
                      <div style={{ position: 'absolute', top: 0, left: 0, width: 40, height: 6, background: '#60A5FA', borderRadius: 2 }} />
                      <div style={{ position: 'absolute', top: 0, left: 0, width: 6, height: 40, background: '#60A5FA', borderRadius: 2 }} />
                    </div>
                    <div className="absolute top-0 right-0 w-10 h-10">
                      <div style={{ position: 'absolute', top: 0, right: 0, width: 40, height: 6, background: '#60A5FA', borderRadius: 2 }} />
                      <div style={{ position: 'absolute', top: 0, right: 0, width: 6, height: 40, background: '#60A5FA', borderRadius: 2 }} />
                    </div>
                    <div className="absolute bottom-0 left-0 w-10 h-10">
                      <div style={{ position: 'absolute', bottom: 0, left: 0, width: 40, height: 6, background: '#60A5FA', borderRadius: 2 }} />
                      <div style={{ position: 'absolute', bottom: 0, left: 0, width: 6, height: 40, background: '#60A5FA', borderRadius: 2 }} />
                    </div>
                    <div className="absolute bottom-0 right-0 w-10 h-10">
                      <div style={{ position: 'absolute', bottom: 0, right: 0, width: 40, height: 6, background: '#60A5FA', borderRadius: 2 }} />
                      <div style={{ position: 'absolute', bottom: 0, right: 0, width: 6, height: 40, background: '#60A5FA', borderRadius: 2 }} />
                    </div>
                  </div>
                  {/* Animated scan line */}
                  {!scanned && (
