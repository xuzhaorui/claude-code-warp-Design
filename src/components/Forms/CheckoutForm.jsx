  ...
  return (
    <div>
      ...
      <div className="mt-1" style={{ transform: 'rotate(-1deg)' }}>
        <div className="rounded-[14px] p-1.5 inline-block" style={{ background: '#60A5FA' }}>
          <div className="rounded-[10px] py-1.5 px-3 text-center inline-block" style={{ background: '#60A5FA', transform: 'skewX(-5deg)' }}>
            <span
